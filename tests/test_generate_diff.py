...
@pytest.mark.parametrize('first_file_path, second_file_path, format, correct_file_path', [
    (
            'complex_before_json',
            'complex_after_json',
            'stylish',
...
def test_generate_diff(first_file_path, second_file_path, format, correct_file_path, request):
